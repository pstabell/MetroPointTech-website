        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold mb-4 text-slate-800">👨‍💼 Agent First</h3>
            ...
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold mb-4 text-slate-800">🔨 Build What We Use</h3>
              <p className="text-slate-800">
            ...
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold mb-4 text-slate-800">🗣️ Listen to the Community</h3>
              <p className="text-slate-800">
            ...
            <div className="bg-white rounded-xl p-8">
              <h3 className="text-xl font-bold mb-4 text-slate-800">🚫 No Custom Dev Shop</h3>
              <p className="text-slate-800">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="bg-white text-slate-800 hover:bg-neutral-lighter px-8 py-4 rounded-lg text-lg font-semibold transition"
            >
              Start Free Trial
            </Link>
          </div>
