...
export default function Hero() {
  return (
    <section className="relative text-white py-20 md:py-32" style={{background: 'linear-gradient(135deg, #065F46 0%, #6D28D9 60%, #4C1D95 100%)'}}>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              ...
              <div className="text-sm text-violet-100">30 years of agency experience</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-3xl mb-2">🤖</div>
              <div className="text-lg font-semibold mb-1">Agentic AI</div>
              <div className="text-sm text-violet-100">Autonomous workflows, not chatbots</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-3xl mb-2">⚡</div>
              <div className="text-lg font-semibold mb-1">Zero-Touch Operations</div>
              <div className="text-sm text-violet-100">Your back office runs itself</div>
            </div>
          </div>
        </div>
      </div>
