...
export default function Footer() {
  return (
    <footer className="text-slate-700" style={{ background: 'linear-gradient(135deg, #F0FDFA 0%, #F5F3FF 100%)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4"><AgenientWordmark variant="stretch" size="30px" /></div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/AAMS-CRM" className="text-slate-600 hover:text-accent transition">
                  Agenient CRM
                </Link>
              </li>
              <li>
                <Link href="/AAMS/agents" className="text-slate-600 hover:text-accent transition">
                  Agenient Solo
                </Link>
              </li>
              <li>
                <Link href="/ai-agent-teams" className="text-slate-600 hover:text-accent transition">
                  AI Agents
                </Link>
              </li>
              <li>
                <Link href="/products/wrap-proposal-generator" className="text-slate-600 hover:text-accent transition">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contact" className="text-slate-600 hover:text-accent transition">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/commission-calculator" className="text-slate-600 hover:text-accent transition">
        ...
        <div className="border-t border-slate-200 mt-8 pt-8 text-center text-sm text-slate-600 space-y-2">
